...
class WorldEntry(models.Model):
    ...
    def to_dict(self):
        return {
            "id": self.id,
            "name": self.name,
            "icon_url": f"https://acegrin.github.io/parafinah-assets/World/Android/world/{self.id}.png",
            "bundle_url": f"https://acegrin.github.io/parafinah-assets/World/Android/world/{self.id}",
            "description": self.description,
            "version": self.version,
            "created_at": int(self.created_at.timestamp()),
            "updated_at": int(self.updated_at.timestamp()),
